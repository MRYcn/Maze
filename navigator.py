...
class Navigator:
    def __init__(self, game):
        ...
        self.directional_guidance = game.data['data']['preference']['directional_guidance']
    ...
    def update(self):  # st:game.st
        ...
        if self.game.beginning:
            ...
            if not self.end:
                ...
                self.directional_guidance = self.game.data['data']['preference']['directional_guidance']
        ...
        self.mm.display()
        if self.end and self.directional_guidance: #即end仍在UI上，游戏进行中

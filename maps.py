...
class Map_Manager:
    def __init__(self, navigator):
        ...
        map_files = ['map1.json', 'map2.json', 'map3.json', 'map4.json', 'map5.json', 'map6.json', 'map7.json',
                     'map8.json', 'map9.json', 'map10.json', 'map11.json', 'map12.json', 'map13.json', 'map14.json',
                     'map15.json']
        self.map_dicts = []
    ...
    def judge_action(self):
        ...
        for suf in self.map_sufs:
            if suf.__class__.__name__ == 'Arrow' and suf.loc in [(590, 245), (590, 265), (610, 245), (610, 265),
                                                                 (600, 255)] and suf.ang == self.navigator.ang:
                arrow = suf
            if suf.loc == (600, 255):
